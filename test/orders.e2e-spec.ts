...
describe('OrdersController (e2e)', () => {
  ...
  beforeAll(async () => {
    ...
    mockOrderRepository.findOne.mockImplementation((options) => ({
      id: '123e4567-e89b-12d3-a456-426614174001',
      user_id: mockUser.id,
      status: OrderStatus.PENDING,
      total: 100,
  ...
  describe('GET /orders', () => {
    ...
    it('should return user orders without status filter', async () => {
      ...
      expect(res.body.orders[0]).toHaveProperty('id', '123e4567-e89b-12d3-a456-426614174001');
    });
  ...
  describe('GET /orders/:id', () => {
    it('should return order details', async () => {
      ...
      expect(res.body).toHaveProperty('id', '123e4567-e89b-12d3-a456-426614174001');
  ...
  describe('POST /orders', () => {
    ...
    it('should create a new order', async () => {
      ...
      try {
        ...
        // eslint-disable-next-line no-console
        console.log('Order creation error response:', err.response?.body || err);
        throw err;
      }
