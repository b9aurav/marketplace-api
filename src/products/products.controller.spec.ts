...
describe('ProductsController', () => {
  ...
  describe('findAll', () => {
    it('should return all products with filters', async () => {
      const dto: FindProductsDto = { category: 'cat', min_price: 10, max_price: 100, sort: 'price_asc', page: 1, limit: 10 } as any;
      const mockResult = { data: [{ id: '1' }], pagination: { total: 1, page: 1, limit: 10 } };
