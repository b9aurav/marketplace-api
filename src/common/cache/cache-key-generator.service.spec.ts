...
describe('CacheKeyGenerator', () => {
  ...
  describe('generateKey', () => {
    ...
    it('should handle object values', () => {
      ...
      expect(result).toBe('admin:users:filters={"status":"active","role":"admin"}');
    });
  ...
  describe('generateAnalyticsKey', () => {
    it('should generate analytics key with date range', () => {
      ...
      const result = service.generateAnalyticsKey(prefix, dateFrom, dateTo, interval);

      expect(result).toBe('admin:sales:analytics:from=2023-01-01:interval=day:to=2023-01-31');
    });
