...
import { UploadImageDto, FileUploadResponseDto, GetFilesQueryDto } from '../dto/file-upload.dto';
...
describe('FileUploadController Logic', () => {
  ...
  describe('uploadImage', () => {
    it('should upload image successfully', async () => {
      ...
      const result = await fileUploadService.uploadImage(mockFile, uploadDto, mockUser.id);
  ...
  describe('deleteImage', () => {
    it('should delete image successfully', async () => {
      ...
      expect(fileUploadService.deleteImage).toHaveBeenCalledWith('file-id', mockUser.id);
    });
  });
