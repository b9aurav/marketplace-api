...
export class DashboardController {
  ...
  @ApiOperation({
    ...
    description:
      "Retrieve comprehensive dashboard metrics including user, product, order counts and growth rates. Data is cached for 5 minutes for optimal performance.",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      "Retrieve detailed sales analytics with trend data, growth rates, and performance metrics. Supports date range filtering and interval grouping (day, week, month). Data is cached for 5 minutes.",
  })
  @ApiResponse({
    status: 200,
