...
export class FileUploadController {
  ...
  @ApiOperation({
    ...
    description: 'Upload and process an image file with validation and optimization',
  })
  ...
  @ApiOperation({
    ...
    description: 'Retrieve a paginated list of uploaded files with filtering options',
  })
  @ApiQuery({
    name: 'page',
    required: false,
