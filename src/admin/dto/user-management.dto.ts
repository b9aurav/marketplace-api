import { IsOptional, IsInt, Min, Max, IsString, IsEnum, IsDateString, IsUUID, IsBoolean } from 'class-validator';
...
export class GetUsersQueryDto {
  ...
  @ApiPropertyOptional({ enum: ['name', 'email', 'created_at'], description: 'Sort field', default: 'created_at' })
  @IsOptional()
...
export class GetUserAnalyticsQueryDto {
  ...
  @ApiPropertyOptional({ enum: ['day', 'week', 'month'], description: 'Grouping interval', default: 'day' })
  @IsOptional()
