...
describe('UserManagementService', () => {
  ...
  describe('getUserDetails', () => {
    ...
    it('should throw NotFoundException when user not found', async () => {
      ...
      await expect(service.getUserDetails(userId)).rejects.toThrow(NotFoundException);
    });
  });
  ...
  describe('updateUserStatus', () => {
    ...
    it('should throw NotFoundException when user not found', async () => {
      ...
      await expect(service.updateUserStatus(userId, updateDto, adminId)).rejects.toThrow(NotFoundException);
    });
  });
  ...
  describe('getUserAnalytics', () => {
    ...
    it('should fetch analytics from database when cache miss', async () => {
      ...
      mockQueryBuilder.getRawMany
        ...
        .mockResolvedValueOnce([{ period: '2023-01', active_users: '50', login_count: '200' }]); // activity metrics
